                                    ...
                                    <table class="table">
                                        ...
                                        <?php foreach ($altinlar as $k): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- GÜNCELLE BUTONU -->
                                                    <form action="altinGuncelle.php" method="GET" style="display:inline;">
                                                        <input type="hidden" name="id" value="<?= $k['id'] ?>">
                                                        <button class="btn btn-info btn-fw" type="submit">Güncelle</button>
                                                    </form>
                                                    <!-- SİLME BUTONU -->
                                                    <form action="altinSil.php" method="POST" style="display:inline;">
                                                        <input type="hidden" name="id" value="<?= $k['id'] ?>">
                ...
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    ...
                    <span class="text-muted float-none float-sm-end d-block mt-1 mt-sm-0 text-center"> <span
                                class="text-muted float-none float-sm-end d-block mt-1 mt-sm-0 text-center">Hand-crafted & made with <i
                                    class="mdi mdi-heart text-danger"></i></span> <i
