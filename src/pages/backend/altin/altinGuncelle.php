                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card" >
                            <div class="card-body col-lg-6" >
                                ...
                                <form class="forms-sample" action="altinGuncelle.php" method="post">
                                    <input type="hidden" name="id" value="<?= $altin['id'] ?>">
                                    <div class="form-group row">
                                        <label for="adı" class="col-sm-3 col-form-label">Adı</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="adi" name="adi" value="<?= $altin['adi'] ?>" placeholder="Adı" required maxlength="100" minlength="4">
                                        </div>
                                    </div>
