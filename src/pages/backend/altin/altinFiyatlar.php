            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Altın Fiyatları</h4>
                                </p>
                                    ...
                                    <table class="table">
                                        ...
                                        <?php foreach ($altinlar as $k): ?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($k['alis']); ?></td>
                                                <td><?php echo htmlspecialchars($k['satis']); ?></td>
                                                <td><?php echo $k['fiyat_tarih']; ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
