                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card" >
                            <div class="card-body col-lg-6" >
                                ...
                                <form class="forms-sample" action="kurEkle.php" method="post">
                                    <div class="form-group row">
                                        <label for="kod" class="col-sm-3 col-form-label">Kod</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="kod" name="kod" placeholder="Kod" maxlength="7" minlength="2" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
